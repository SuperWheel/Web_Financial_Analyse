# CLAUDE.md —— Web_Financial_Analyse 财务分析系统
...
- ⏭ Phase 3~5：比率分析 / 多期对比 / Excel 模板导入导出。
...
- 视图组件：`frontend/src/views/Dashboard.vue`、`StatementsView.vue`
- 状态管理：`frontend/src/stores/{company,statement}.ts`
- API 封装：`frontend/src/api/{http,company,statement}.ts`
